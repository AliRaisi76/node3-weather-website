...
const forecast = (latitude, longitude, callback) => {
    ...
    request({ url, json: true }, (error, { body }) => {
        if (error) {
            ...
            callback(undefined, `${body.current.weather_descriptions[0]}. Currently out there is ${degree}. It feels like ${feelsLike} and humidity is ${body.current.weather_descriptions.humidity}`)
        }
    })
}
